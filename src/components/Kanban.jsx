...
//esta dependencia permite mover los componentes de manera flotante, agarrarlos y arrastrarlos.
                    ...
                    <Droppable key={section.id} droppableId={section.id}>
                        {(provided) => (
                            <div {...provided.droppableProps} className="kanban_section" ref={provided.innerRef}>
                                ...
                                <div className="kanban_section_content">{section.tasks.map((task, index) => (
